...
mask_valid = np.array(Image.open(os.path.join(args.heatmap_folder_path,'SegMap.png'))).astype(np.float64)

SE = disk(10)
binary_mask = mask_valid > (150 / 255.0)
mask_valid = closing(binary_mask, SE)
